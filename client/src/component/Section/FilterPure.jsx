...
export default function FilterLawyer({select}) {
  const [filter,setFilter] = useState([]);
  const[collection, setCollection] = useState([]);

  useEffect(() => {
    setFilter(Lawyers);
    setCollection([...new Set(Lawyers.map((key)=>key.prize))]);
  },[])
  
  // const handleChange = (e) => {
  //   const filterData = Lawyers.filter((key)=> key.prize === e)
...
// export default function FilterPure({lawyers}) {
//   const [filterParams, setFilterParams] = useState(lawyers)
//   // const [filterParams, setFilterParams] = useState({ available: false, rate: 0, location: "", price: 0, experience: 0,avgTime: 0 })
//   // const [available, setAvailable] = useState(false);
//   // const [rate, setRate] = useState(false);
//   // const [location, setLocation] = useState(false);
//   // const [price, setPrice] = useState(false);
//   // const [experience, setExperience] = useState(false);
//   // const [avgTime, setAvgTime] = useState(false);


//   const getSelectedValue = (event) => {
//     // return event.target.value;
//     return filterParams[event.target.name] = event.target.value
// }
...
// });
//   const handleParamsSelection = (category) => {
//     setFilterParams(category)
//     // setAvailable(category);
//     // setRate(category);
//     // setLocation(category);
//     // setPrice(category);
//     // setExperience(category);
//     // setAvgTime(category);
//   };

//   // const filteredLawyers = products.filter(
...
//       {/* <select onChange={(e) => handleParamsSelection(e.target.value)}> */}
//         <h1>Rate</h1>
...
//         <option value="option4">Michigan</option>
//       </select>
//       <select onChange={(e) => getSelectedValue(e.target.value)}>
//       {/* <select onChange={(e) => handleParamsSelection(e.target.value)}> */}
//       <h1>Price</h1>
//         <option value="option1">500</option>
//         <option value="option2">450</option>
//         <option value="option3">400</option>
//         <option value="option4">350</option>
//         <option value="option5">300</option>
//         <option value="option6">250</option>
//         <option value="option7">150</option>
//         <option value="option8">100</option>
//       </select>
//       <select onChange={(e) => getSelectedValue(e.target.value)}>
//       {/* <select onChange={(e) => handleParamsSelection(e.target.value)}> */}
//       <h1>Experience</h1>
...
//         <MDBCol size='9'>
//           <MDBTabsContent>
//             <MDBTabsPane show={verticalActive === 'tab1'}> lawyers here</MDBTabsPane>
//           </MDBTabsContent>
//         </MDBCol>
//       </MDBRow>
//     </>
